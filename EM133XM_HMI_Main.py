...
class MainView(tk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        # Add buttons       
        self.Menubtn1 = tk.Button(self.Headerframe, height = 1, width = BUTTON_WIDTH, bg = BUTTON_COLOUR, text="BILLING",command=lambda:[self.DisplayPage(1)])
        self.Menubtn1.pack(side="left", anchor = "nw", fill = "y")
        self.Menubtn2 = tk.Button(self.Headerframe, height = 1, width = BUTTON_WIDTH, bg = BUTTON_COLOUR, text="ENGINEERING",command=lambda:[self.DisplayPage(2)])
        self.Menubtn2.pack(side="left", anchor = "nw", fill = "y")
        self.Menubtn3 = tk.Button(self.Headerframe, height = 1, width = BUTTON_WIDTH, bg = BUTTON_COLOUR, text="HISTORY",command=lambda:[self.DisplayPage(3)])
        self.Menubtn3.pack(side="left", anchor = "nw", fill = "y")
        self.Menubtn4 = tk.Button(self.Headerframe, height = 1, width = BUTTON_WIDTH, bg = BUTTON_COLOUR, text="SETTINGS",command=lambda:[self.DisplayPage(4)])
...
# Logo
        ...
        self.Logo_File = self.Logo_File.resize((int(self.Logo_Width / self.Logo_Height * 30), 30), Image.Resampling.LANCZOS)
